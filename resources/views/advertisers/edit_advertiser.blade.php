...
<div class="container-xl">
 ...
 <div class="text-muted mt-1"> Profile ID: {{$advertiser->id}}</div>
        ...
        <div class="col-auto ml-auto d-print-none">
          <div class="d-flex">
            <a href="{{route('advertisers')}}" class="btn btn-secondary">
 ...
 <div class="col-md-6 card">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane active show" id="tabs-home-13">
                <form action="{{route('advertiser.edit')}}" method="post" class="form">
                    @csrf
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name')
                            {{__('is-invalid')}}
                        @enderror" id="name" value="{{$advertiser->name}}">
                        @error('name')
                    ...
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="email"  value="{{$advertiser->email}}">
                    @error('email')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="phone_no" value="{{$advertiser->phone_no}}">
                        @error('phone_no')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="job_role" value="{{$advertiser->job_role}}">
                        @error('job_role')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="address" value="{{$advertiser->address}}">
                        @error('address')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    ...
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="city" value="{{$advertiser->city}}">
                        @error('city')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="state" value="{{$advertiser->state}}">
                        @error('state')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    ...
                    <div class="col-lg-6">
                        ...
                        {{__('is-invalid')}}
                    @enderror" id="postal_code" value="{{$advertiser->postal_code}}">
                        @error('postal_code')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        <select name="country" id="country" class="form-select select2">
                            ...
                            <option value="{{$country['code']}}" {{ $advertiser->country == $country['code'] ? 'selected' : '' }}>{{ $country['code'] .' - '. $country['name']}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="manager" id="manager" class="form-select">
                            ...
                            <option value="{{$advertiser->manager}}" {{$advertiser->manager == $user->id ? 'selected' : '' }}>{{$user->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group ">
                            ...
                            <label class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" {{ $advertiser->status == $account_status ? 'checked' : '' }} value="{{$account_status}}">
    ...
    <ul class="nav nav-tabs" data-bs-toggle="tabs">
        ...
        <li class="nav-item ml-auto">
            <form action="{{route('advertiser.reset_password')}}" method="post">
                @csrf
                <input type="hidden" name="id" value="{{$advertiser->id}}">
    ...
    <div class="tab-content">
        <div class="tab-pane active show" id="tabs-home-13">
            <form action="{{route('advertiser.change_password')}}" method="post" class="form">
                @csrf
