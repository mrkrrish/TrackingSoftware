    ...
    <div class="page-header d-print-none">
      <div class="row align-items-center">
        <div class="col">
          ...
          <div class="text-muted mt-1">Showing {{$affiliates->count().' out of total '. $affiliates->total().' Affiliates'}}</div>
        </div>
        <!-- Page title actions -->
        ...
        <div class="card">
          <div class="card-body">
            <div class="row g-2 align-items-center">
              <div class="col-auto">
                <span class="avatar">{{Str::limit($affiliate->name, 2, '')}}</span>
              </div>
              <div class="col">
                <h3 class="mb-0"><a href="{{route('affiliate.profile', $affiliate->id)}}">{{$affiliate->name}}</a></h3>
                <div class="text-muted text-h5">{{$affiliate->job_role}}</div>
              </div>
            ...
            <div class="row align-items-center mt-4">
              ...
              <div class="col-auto">
                <div class="btn-list">
                  ...
                  <a href="{{route('affiliate.profile', $affiliate->id)}}" class="btn btn-outline-secondary btn-sm">
                    Profile
                  </a>
                  <form action="{{route('affiliate.delete')}}" method="post">
